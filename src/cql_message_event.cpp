...
cql::cql_message_event_t::cql_message_event_t() :
...
cql::cql_message_event_t::buffer()
{
    return _buffer;
}

cql_byte_t
cql::cql_message_event_t::opcode() const
{
    return CQL_OPCODE_EVENT;
}

std::string
cql::cql_message_event_t::str() const
{
    return "EVENT";
}

cql_int_t
cql::cql_message_event_t::event_type() const
{
    return _event_type;
}

cql_int_t
cql::cql_message_event_t::schema_change() const
{
    return _schema_change;
}

cql_int_t
cql::cql_message_event_t::topology_change() const
{
    return _topology_change;
}

cql_int_t
cql::cql_message_event_t::status_change() const
{
    return _status_change;
}

const std::string&
cql::cql_message_event_t::keyspace() const
{
    return _keyspace;
}

const std::string&
cql::cql_message_event_t::column_family() const
{
    return _column_family;
}

const std::string&
cql::cql_message_event_t::ip() const
{
    return _ip;
}

cql_int_t
cql::cql_message_event_t::port() const
{
    return _port;
}

cql_int_t
cql::cql_message_event_t::size() const
{
    return _buffer->size();
}

bool
cql::cql_message_event_t::consume(
    cql::cql_error_t*)
{
    _ip = "";
    _port = 0;
...
bool
cql::cql_message_event_t::prepare(
    cql::cql_error_t*)
{
    cql::vector_stream_t buffer(*_buffer);
