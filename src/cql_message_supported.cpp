...
cql::cql_message_supported_t::buffer()
{
    return _buffer;
}

void
cql::cql_message_supported_t::compressions(
...
void
cql::cql_message_supported_t::versions(
    const std::list<std::string>& v)
{
    _versions = v;
}
...
bool
cql::cql_message_supported_t::consume(
    cql::cql_error_t*)
{
...
bool
cql::cql_message_supported_t::prepare(
    cql::cql_error_t*)
{
    cql::vector_stream_t buffer(*_buffer);
