...
bool
cql::cql_list_impl_t::get_bool(int i,
                               bool& output) const
{
...
bool
cql::cql_list_impl_t::get_int(int i,
...
bool
cql::cql_list_impl_t::get_float(int i,
                                float& output) const
{
    if (i < 0 || i > _elements.size()) {
        return false;
...
bool
cql::cql_list_impl_t::get_double(int i,
                                 double& output) const
{
    if (i < 0 || i > _elements.size()) {
        return false;
...
bool
cql::cql_list_impl_t::get_bigint(int i,
...
bool
cql::cql_list_impl_t::get_string(int i,
...
bool
cql::cql_list_impl_t::get_data(int i,
