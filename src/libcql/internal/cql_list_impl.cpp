...
cql::cql_list_impl_t::cql_list_impl_t() :
    _type(-1),
    _offset(0)
{}

void
cql::cql_list_impl_t::read(column_t column)
{
    _column = column;
...
cql::cql_short_t
cql::cql_list_impl_t::member_type() const
{
    return _type;
}
...
void
cql::cql_list_impl_t::get_list(std::list<bool>& output) const
{
...
void
cql::cql_list_impl_t::get_list(std::list<cql::cql_int_t>& output) const
{
    decode_list(output, (std::istream& (&) (std::istream&, int&)) &cql::decode_int);
}

void
cql::cql_list_impl_t::get_list(std::list<float>& output) const
{
    decode_list(output, (std::istream& (&) (std::istream&, float&)) &cql::decode_float);
}

void
cql::cql_list_impl_t::get_list(std::list<double>& output) const
{
    decode_list(output, (std::istream& (&) (std::istream&, double&)) &cql::decode_double);
}

void
cql::cql_list_impl_t::get_list(std::list<cql::cql_bigint_t>& output) const
{
    decode_list(output, (std::istream& (&) (std::istream&, cql::cql_bigint_t&)) &cql::decode_bigint);
}

void
cql::cql_list_impl_t::get_list(std::list<std::string>& output) const
{
