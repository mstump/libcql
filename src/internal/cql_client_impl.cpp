...
cql::internal::cql_client_impl_t<cql_transport_t>::cql_client_impl_t(boost::asio::io_service& io_service,
                                                                     cql_transport_t* stream) :
...
void
transport(cql_transport_t* transport);

template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::connect(const std::string& server,
                                                           unsigned int port,
                                                           ...
                                                           const std::list<std::string>& events)
{
    ...
    _resolver.async_resolve(query,
                            boost::bind(&cql_client_impl_t<cql_transport_t>::resolve_handle,
                                        this,
...
template <typename cql_transport_t>
cql_stream_id_t
cql::internal::cql_client_impl_t<cql_transport_t>::query(const std::string& query,
                                                         ...
                                                         cql::cql_client_t::cql_message_errback_t errback)
{
    ...
    cql_stream_id_t stream = write_message(m,
                                           boost::bind(&cql_client_impl_t<cql_transport_t>::write_handle,
                                                       this,
                                                       boost::asio::placeholders::error,
...
template <typename cql_transport_t>
cql_stream_id_t
cql::internal::cql_client_impl_t<cql_transport_t>::prepare(const cql::cql_message_prepare_t& message,
                                                           cql::cql_client_t::cql_message_callback_t callback,
                                                           cql::cql_client_t::cql_message_errback_t errback)
{
...
template <typename cql_transport_t>
cql_stream_id_t
cql::internal::cql_client_impl_t<cql_transport_t>::execute(const cql::cql_message_execute_t& message,
                                                           cql::cql_client_t::cql_message_callback_t callback,
                                                           cql::cql_client_t::cql_message_errback_t errback)
{
    cql_stream_id_t stream = write_message(message,
...
template <typename cql_transport_t>
inline void
cql::internal::cql_client_impl_t<cql_transport_t>::log(cql_short_t level,
...
template <typename cql_transport_t>
cql_stream_id_t
cql::internal::cql_client_impl_t<cql_transport_t>::get_new_stream()
{
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::resolve_handle(const boost::system::error_code& err,
                                                                  boost::asio::ip::tcp::resolver::iterator endpoint_iterator)
{
    if (!err) {
        ...
        boost::asio::async_connect(_transport->lowest_layer(),
                                   endpoint_iterator,
                                   boost::bind(&cql_client_impl_t<cql_transport_t>::connect_handle,
                                               this,
                                               boost::asio::placeholders::error));
    }
    else {
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::connect_handle(const boost::system::error_code& err)
{
    if (!err) {
        log(CQL_LOG_DEBUG, "connection successful to remote host");
        if (_transport->requires_handshake()) {
            _transport->async_handshake(boost::bind(&cql_client_impl_t<cql_transport_t>::handshake_handle,
                                                    this,
                                                    boost::asio::placeholders::error));
        }
        else {
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::handshake_handle(const boost::system::error_code& err)
{
    if (!err) {
...
template <typename cql_transport_t>
cql_stream_id_t
cql::internal::cql_client_impl_t<cql_transport_t>::write_message(const cql::cql_message_t& data,
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::write_handle(const boost::system::error_code& err,
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::header_read()
{
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::header_read_handle(const boost::system::error_code& err)
{
    if (!err) {
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::body_read(const cql::internal::cql_header_t& header)
{
    boost::asio::async_read(*_transport,
                            _receive_buffer,
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::body_read_handle(const cql::internal::cql_header_t& header,
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::events_register()
{
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::options_write()
{
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::startup_write()
{
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::ready_receive()
{
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::event_receive()
{
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::error_receive(const cql::internal::cql_header_t& header)
{
    std::istream response_stream(&_receive_buffer);
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::supported_receive()
{
    std::istream response_stream(&_receive_buffer);
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::result_receive(const cql::internal::cql_header_t& header)
{
    std::istream response_stream(&_receive_buffer);
...
template <typename cql_transport_t>
bool
cql::internal::cql_client_impl_t<cql_transport_t>::defunct()
{
    return _defunct;
}
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::close(cql_error_t& err)
{
...
template <typename cql_transport_t>
void
cql::internal::cql_client_impl_t<cql_transport_t>::close()
{
...
template <typename cql_transport_t>
inline void
cql::internal::cql_client_impl_t<cql_transport_t>::check_transport_err(const boost::system::error_code& err)
{
