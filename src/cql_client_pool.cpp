...
cql::cql_client_pool_t::cql_client_pool_t(
...
cql::cql_client_pool_t::add_client(
    ...
    const std::map<std::string, std::string>& credentials)
{
    ...
    client_container->client->connect(server,
                                      port,
                                      boost::bind(&cql_client_pool_t::connect_callback, this, promise, ::_1),
                                      boost::bind(&cql_client_pool_t::connect_errback, this, promise, ::_1, ::_2));
    _clients.push_back(client_container.release());
    return shared_future;
}

cql_stream_id_t
cql::cql_client_pool_t::query(
...
void
cql::cql_client_pool_t::connect_callback(
...
void
cql::cql_client_pool_t::connect_errback(
    boost::shared_ptr<boost::promise<cql::cql_future_connection_t> > promise,
    cql::cql_client_t&                                               client,
