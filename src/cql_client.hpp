...
namespace cql {
    ...
    public:
        ...
        typedef boost::function<void(cql_client_t&, cql_message_event_t*)>                              cql_event_callback_t;
        typedef boost::function<void(cql_client_t&, const cql_stream_id_t, cql::cql_message_result_t*)> cql_message_callback_t;
        ...
        virtual boost::shared_future<cql::cql_future_result_t>
        execute(
            cql::cql_message_execute_t& message) = 0;
